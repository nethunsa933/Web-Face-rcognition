    ...
    <div class="card">
        <div class="card-body register-card-body">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="input-group mb-3">
                    <input id="StudentID" type="number" class="form-control @error('StudentID') is-invalid @enderror" name="StudentID" value="{{ old('StudentID') }}" required autocomplete="StudentID" autofocus placeholder="Student code">
                    @error('StudentID')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
