...
<head>
    ...
    <title>The Face Recognition</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-dark navbar-light">
            ...
            <!-- Right navbar links -->
            <ul class="navbar-nav ml-auto navbar-dark-primary">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{url ('admin/dashboard') }}" class="brand-link">
                <img src="{{ asset('image/facial-recognition.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item has-treeview menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('StudentList.index') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>นักศึกษา</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('ProfessorList.index') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>เจ้าหน้าที่ & อาจารย์</p>
                                    </a>
                                </li>
